...
parser.add_argument('-o','--output', type=str, default='quad.log',
                    help='Name of output file for writing the results (default rect_quad.log).')
parser.add_argument('-ro','--rect_output', type=str, default='rect_quad.log',
                    help='Name of output file for writing the results (default rect_quad.log).')
parser.add_argument('-oc','--output_conv', type=str, default='rect_quad_conv.log',
...
if __name__=='__main__':
    ...
    for meth, ofile in zip(('elliptical', 'rectangular'), 
                          (args.output, args.rect_output)):
